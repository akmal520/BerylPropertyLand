    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col justify-center items-center text-center lg:px-20 lg:text-left lg:items-start h-full lg:gap-4 gap-6">
                <h1 className="lg:w-[490px] lg:h-[146px] text-[#110229] select-none text-4xl font-semibold drop-shadow-sm lg:leading-normal lg:text-5xl">
                    Easy way to find a perfect property
                </h1>

                <h3 className="lg:mt-4 lg:w-[470px] lg:h-[72px] select-none text-[#585981] lg:leading-relaxed text-lg lg:text-xl">
