    ...
    return (
        <section className="container mx-auto p-6 bg-gray-100 rounded-lg shadow-lg">
            <div className="text-center mb-8">
                ...
                <p className="text-lg text-gray-700">Menjadi perusahaan digital marketing properti terdepan yang memberikan solusi inovatif dan terpercaya dalam membantu masyarakat menemukan dan memasarkan properti dengan cara yang efisien, modern, dan berbasis teknologi.</p>
            </div>
            <div>
                ...
                <ul className="list-disc list-inside text-lg text-gray-700">
                    ...
                    <li>Memahami kebutuhan dan preferensi klien untuk memberikan solusi properti yang sesuai.</li>
                </ul>
            </div>
        </section>
    );
